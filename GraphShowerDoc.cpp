...
CGraphShowerDoc::CGraphShowerDoc() noexcept
{
	// TODO: 在此添加一次性构造代码
...
// 缩略图的支持
void CGraphShowerDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CGraphShowerDoc::InitializeSearchContent()
{
...
void CGraphShowerDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
